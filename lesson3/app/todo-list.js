...
var TodoList = (function () {
    function TodoList(our_todos, http_service) {
    ...
    TodoList.prototype.ngOnInit = function () {
        var _this = this;
        this.http_service.getData().subscribe(function (json_string) {
            console.log(json_string);
            _this.http_list = json_string;
        }, function (error) {
            console.error(error);
            alert(error);
        });
    ...
    TodoList = __decorate([
        ...
        __metadata('design:paramtypes', [todo_service_1.TodoService, todo_service_with_http_1.TodoService_with_http])
    ], TodoList);
    return TodoList;
}());
